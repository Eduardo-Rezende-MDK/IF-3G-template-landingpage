...
1. **[CHANGELOG.md](file:///c:/INTEGRAFOODS/github/mussarela-landing-showcase/IA/CHANGELOG.md)**
   * Registro histórico de todas as versões do projeto (**v1.0.0**, **v1.1.0** e **v2.0.0 SSG**).

2. **[01_investigacao_spa_vs_ssr_ec2.md](file:///c:/INTEGRAFOODS/github/mussarela-landing-showcase/IA/01_investigacao_spa_vs_ssr_ec2.md)**
...
3. **[02_plano_de_evolucao_ssg.md](file:///c:/INTEGRAFOODS/github/mussarela-landing-showcase/IA/02_plano_de_evolucao_ssg.md)**
